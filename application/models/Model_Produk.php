...
class Model_Produk extends CI_Model
{
	...
	{
		if($_SESSION['tipe'] === 'admin'){
			$this->db->select('b.id_kategori, concat(c.username, "-", b.nama_kategori) as nama_kategori, c.username');
			$this->db->from('kategori as b');
			$this->db->join('user as c','c.id_username = b.user_id');
			return $this->db->get()->result_array();
		}else{
